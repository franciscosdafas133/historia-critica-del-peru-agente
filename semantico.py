...
def _embeber_consulta(texto):
    ...
    try:
        ...
        # fallo de cuota en una consulta de 10 s. El limite del trial de
        # Cohere son 40 llamadas por minuto, asi que en uso real (un alumno
        # escribiendo preguntas) no se toca; en una rafaga de pruebas si.
        return None
